...
import { LinkExternal, Flex, Svg, Image, Button } from "@tankswap/uikit";
...
> = ({
  ...
  externalText,
  externalLinkUrl,
  helpImage = <Image src="https://cdn.tankswap.com/help/help.png" alt="Get some help" width={160} height={108} />,
}) => {
