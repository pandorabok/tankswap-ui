import { Currency, CurrencyAmount, Pair, ZERO } from '@tankswap/sdk'
import { Pool as V3Pool, TickList } from '@tankswap/v3-sdk'
import { getQuoteExactIn, getQuoteExactOut } from '@tankswap/stable-swap-sdk'
import {
  Pool as IPool,
  Pool,
  QuoteProvider,
