...
```bash
pnpm i @tankswap/awgmi @tanstack/react-query
```
...
```jsx
import { createClient, AwgmiConfig, useConnect, getDefaultProviders, defaultChains } from '@tankswap/awgmi'
import { QueryClient, QueryClientProvider } from '@tanstack/react-query'
import { PetraConnector } from '@tankswap/awgmi/connectors/petra'
import { MartianConnector } from '@tankswap/awgmi/connectors/martain'
import { SafePalConnector } from '@tankswap/awgmi/connectors/safePal'
import { BloctoConnector } from '@tankswap/awgmi/connectors/blocto'
import { FewchaConnector } from '@tankswap/awgmi/connectors/fewcha'

// import { mainnet, testnet } from '@tankswap/awgmi/core'
...
```jsx
import { useConnect, useDisconnect } from '@tankswap/awgmi'
...
```js
import { UserRejectedRequestError } from '@tankswap/awgmi'
