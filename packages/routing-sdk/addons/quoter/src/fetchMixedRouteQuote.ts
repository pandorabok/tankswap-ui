...
import { StablePool, isStablePool } from '@tankswap/routing-sdk-addon-stable-swap'
import { V2Pool, isV2Pool } from '@tankswap/routing-sdk-addon-v2'
import { V3Pool, isV3Pool } from '@tankswap/routing-sdk-addon-v3'
