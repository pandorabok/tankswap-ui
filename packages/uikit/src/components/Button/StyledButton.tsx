...
const StyledButton = styled("button").withConfig({
  ...
  @media (hover: hover) {
    &:hover:not(:disabled):not(.tank-button--disabled):not(.tank-button--disabled):not(:active) {
      opacity: 0.65;
    }
  }

  &:active:not(:disabled):not(.tank-button--disabled):not(.tank-button--disabled) {
    opacity: 0.85;
