...
import { Currency, CurrencyAmount, Percent } from '@tankswap/aptos-swap-sdk'
import { useAccount, useBalance } from '@tankswap/awgmi'
import { useIsMounted } from '@tankswap/hooks'
import { useCurrencyBalance } from 'hooks/Balances'
import useStablePrice from 'hooks/useStablePrice'
import { multiplyPriceByAmount } from 'utils/prices'
import { useTranslation } from '@tankswap/localization'
import { AtomBox, Button, ChevronDownIcon, CopyButton, Text, useModal } from '@tankswap/uikit'
