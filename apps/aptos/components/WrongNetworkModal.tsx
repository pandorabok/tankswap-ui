import { useDisconnect } from '@tankswap/awgmi'
import { useTranslation } from '@tankswap/localization'
import { Button, HelpIcon, Link, Message, MessageText, Modal, ModalV2, Text } from '@tankswap/uikit'
  ...
  return (
    <ModalV2 isOpen={isWrongNetwork}>
      <Modal title={t('Wrong Network')} hideCloseButton>
        ...
        <StyledLink
          href="https://docs.tankswap.finance/get-started-aptos/connection-guide#connect-to-aptos-mainnet"
          external
        >
