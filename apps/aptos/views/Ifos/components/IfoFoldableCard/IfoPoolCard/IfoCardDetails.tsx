...
import { Box, Flex, IfoSkeletonCardDetails, Skeleton, Text, TooltipText, useTooltip } from '@tankswap/uikit'
import { formatNumber, getBalanceNumber } from '@tankswap/utils/formatBalance'
import { DAY_IN_SECONDS } from '@tankswap/utils/getTimePeriods'
