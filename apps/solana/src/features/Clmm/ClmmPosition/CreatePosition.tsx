import { ErrorIcon, Message, MessageText } from '@tankswap/uikit'
import { Box, Flex, Grid, GridItem, HStack, Tag, Text, useDisclosure } from '@chakra-ui/react'
import { ApiV3PoolInfoConcentratedItem, ApiV3Token, PoolFetchType, solToWSol } from '@tankswap/solana-core-sdk'
