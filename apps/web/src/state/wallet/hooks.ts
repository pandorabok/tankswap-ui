import { ChainId, Currency, CurrencyAmount, Native, Token, UnifiedCurrency, ZERO_ADDRESS } from '@tankswap/sdk'
import { useQuery } from '@tanstack/react-query'
import { NonEVMChainId } from '@tankswap/chains'
import { selectedEvmWalletAtom, selectedSolanaWalletAtom } from '@tankswap/ui-wallets/src/state/atom'
import useAccountActiveChain from 'hooks/useAccountActiveChain'
import { useLocalStorage, useWallet } from '@solana/wallet-adapter-react'
import { EvmConnectorNames, SolanaProviderLocalStorageKey, WalletAdaptedNetwork } from '@tankswap/ui-wallets'
...
import { useSelectedWallet } from '@tankswap/ui-wallets/src/state/hooks'
