import { SerializedFarmsState } from '@tankswap/farms'
import { SerializedPoolWithInfo } from '@tankswap/pools'
import { BetPosition, PredictionStatus, PredictionsChartView } from '@tankswap/prediction'
