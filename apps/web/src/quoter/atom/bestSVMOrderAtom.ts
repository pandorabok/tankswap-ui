import { getBestSolanaTrade } from '@tankswap/solana-router-sdk'
import { SPLToken, TradeType, UnifiedCurrencyAmount } from '@tankswap/swap-sdk-core'
import { Loadable } from '@tankswap/utils/Loadable'
import { withTimeout } from '@tankswap/utils/withTimeout'
import { atomFamily } from 'jotai/utils'
import { solanaUserSlippageAtomWithLocalStorage, solanaPriorityFeeAtomWithLocalStorage } from '@tankswap/utils/user'
