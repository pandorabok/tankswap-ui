import { type Pool, type Route, type Trade, toSerializableTrade } from '@tankswap/routing-sdk'
import {
...
import { createStablePool, isStablePool, toSerializableStablePool } from '@tankswap/routing-sdk-addon-stable-swap'
import { createV2Pool, isV2Pool, toSerializableV2Pool } from '@tankswap/routing-sdk-addon-v2'
import { createV3Pool, isV3Pool, toSerializableV3Pool } from '@tankswap/routing-sdk-addon-v3'
import {
  type InfinityRouter,
  getRouteTypeByPools,
  PoolType,
...
import type { TradeType } from '@tankswap/swap-sdk-core'
