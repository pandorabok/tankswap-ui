...
import { AutoColumn, Box, Button, CardBody, RowBetween, Text, useModal } from '@tankswap/uikit'
import { ConfirmationModalContent } from '@tankswap/widgets-internal'

import { useIsExpertMode, useUserSlippage } from '@tankswap/utils/user'
import { FeeAmount, MasterChefV3, NonfungiblePositionManager, Pool } from '@tankswap/v3-sdk'
