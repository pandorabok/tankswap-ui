...
import { Skeleton, Text, Flex, Box, useModal, useMatchBreakpoints, Balance } from '@tankswap/uikit'
import { Pool } from '@tankswap/widgets-internal'

import BigNumber from 'bignumber.js'
import { PoolCategory } from 'config/constants/types'
import { BIG_ZERO } from '@tankswap/utils/bigNumber'
import { formatNumber, getBalanceNumber, getFullDisplayBalance } from '@tankswap/utils/formatBalance'
