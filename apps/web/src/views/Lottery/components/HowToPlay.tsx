...
import { Box, Flex, Text, Heading, Link, Image, useMatchBreakpoints } from '@tankswap/uikit'
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                ...
                <InlineLink external href="https://docs.tankswap.finance/tokenomics/cake/cake-tokenomics">
                  {t('CAKE Tokenomics')}
                </InlineLink>
              </Text>
            </li>
      ...
      <Flex justifyContent="center" alignItems="center" flexDirection={['column', 'column', 'row']}>
        ...
        <Flex maxWidth="300px" flexDirection="column">
          ...
          <Text>
            ...
            <InlineLink external href="https://docs.tankswap.finance/products/lottery/lottery-guide">
