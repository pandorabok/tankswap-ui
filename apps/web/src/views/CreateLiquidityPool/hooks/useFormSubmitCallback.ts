import { BinLiquidityShape, getIdSlippage, getPoolId } from '@tankswap/infinity-sdk'
import { useTranslation } from '@tankswap/localization'
import { isCurrencySorted } from '@tankswap/swap-sdk-core'
import { useToast } from '@tankswap/uikit'
import { Permit2Signature } from '@tankswap/universal-router-sdk'
import { useUserSlippage, useUserSlippagePercent } from '@tankswap/utils/user'
import { encodeSqrtRatioX96 } from '@tankswap/v3-sdk'
