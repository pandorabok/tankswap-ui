import { InstagramIcon, TwitterIcon } from '@tankswap/uikit'
...
const artistConfigBuilder = ({ t, isDark }: ArtistConfigType) => ({
  ...
  bodyText: [
    ...
    t('Cooking hot tanks for their big ol’ mission:'),
  ...
  image: { src: `/images/tankSquad/artist${isDark ? '-dark' : ''}.png`, alt: 'Chef Cecy bio' },
})
