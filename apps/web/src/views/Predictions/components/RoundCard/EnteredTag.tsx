...
import { REWARD_RATE } from '@tankswap/prediction'
import { CheckmarkCircleFillIcon, CheckmarkCircleIcon, Tag, useTooltip } from '@tankswap/uikit'
import { bigIntToBigNumber } from '@tankswap/utils/bigNumber'
