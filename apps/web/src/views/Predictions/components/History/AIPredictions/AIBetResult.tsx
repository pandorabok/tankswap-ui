...
import { BetPosition, REWARD_RATE } from '@tankswap/prediction'
import { BlockIcon, Box, Flex, Heading, InfoIcon, PrizeIcon, ScanLink, Text, useTooltip } from '@tankswap/uikit'
