...
import { Currency, CurrencyAmount, Token } from '@tankswap/swap-sdk-core'
import { FeeTier, FlexGap, Row, Skeleton, Tag, Text, useMatchBreakpoints } from '@tankswap/uikit'
import { formatNumber as formatBalance } from '@tankswap/utils/formatBalance'
import { formatNumber } from '@tankswap/utils/formatNumber'
import { DoubleCurrencyLogo, FiatNumberDisplay } from '@tankswap/widgets-internal'
