...
import { Currency, CurrencyAmount, Price, Token } from '@tankswap/swap-sdk-core'
import { PairDataTimeWindowEnum, UseModalV2Props } from '@tankswap/uikit'
import { encodeSqrtRatioX96, parseProtocolFees, TickMath } from '@tankswap/v3-sdk'
import { RoiCalculatorModalV2 } from '@tankswap/widgets-internal/roi'
