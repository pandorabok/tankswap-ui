...
import { Pair, Token, UnifiedCurrency, UnifiedCurrencyAmount } from '@tankswap/sdk'
import {
  Box,
  Button,
  ChevronDownIcon,
...
import { CurrencyLogo, DoubleCurrencyLogo, SwapUIV2 } from '@tankswap/widgets-internal'
