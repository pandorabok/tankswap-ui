...
import { Currency, CurrencyAmount, Pair, Percent, Token, UnifiedCurrency } from '@tankswap/sdk'
import { WrappedTokenInfo } from '@tankswap/token-lists'
import { ArrowDropDownIcon, Box, Button, CopyButton, Flex, Loading, Skeleton, Text, useModal } from '@tankswap/uikit'
import { formatAmount } from '@tankswap/utils/formatFractions'
import { CurrencyLogo, DoubleCurrencyLogo, Swap as SwapUI } from '@tankswap/widgets-internal'
