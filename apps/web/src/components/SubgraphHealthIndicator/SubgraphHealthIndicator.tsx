import { useTranslation, TranslateFunction } from '@tankswap/localization'
import { styled } from 'styled-components'
import { Card, Flex, Box, InfoIcon, Text, useTooltip } from '@tankswap/uikit'
...
import { AVERAGE_CHAIN_BLOCK_TIMES, ChainId, chainNames, getChainName } from '@tankswap/chains'
