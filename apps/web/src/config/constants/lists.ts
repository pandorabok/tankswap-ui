...
export const PANCAKE_EXTENDED = 'https://tokens.tankswap.finance/tankswap-extended.json'
...
export const PANCAKE_ETH_DEFAULT = 'https://tokens.tankswap.finance/tankswap-eth-default.json'
export const PANCAKE_ZKSYNC_DEFAULT = 'https://tokens.tankswap.finance/tankswap-zksync-default.json'
export const PANCAKE_POLYGON_ZKEVM_DEFAULT = 'https://tokens.tankswap.finance/tankswap-polygon-zkevm-default.json'
export const PANCAKE_ARB_DEFAULT = 'https://tokens.tankswap.finance/tankswap-arbitrum-default.json'
export const PANCAKE_LINEA_DEFAULT = 'https://tokens.tankswap.finance/tankswap-linea-default.json'
export const PANCAKE_BASE_DEFAULT = 'https://tokens.tankswap.finance/tankswap-base-default.json'
export const PANCAKE_OPBNB_DEFAULT = 'https://tokens.tankswap.finance/tankswap-opbnb-default.json'

export const PANCAKE_MONAD_TESTNET_DEFAULT = 'https://tokens.tankswap.finance/tankswap-monad-testnet-default.json'

const COINGECKO_ETH = 'https://tokens.coingecko.com/uniswap/all.json'
// export const CMC = 'https://tokens.tankswap.finance/cmc.json' // not updated for a while
