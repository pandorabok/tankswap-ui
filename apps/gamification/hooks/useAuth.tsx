...
import { LegacyWalletConfig, WalletConnectorNotFoundError, WalletSwitchChainError } from '@tankswap/ui-wallets'
import replaceBrowserHistory from '@tankswap/utils/replaceBrowserHistory'
